...
- I seek to use the register based AVX-512 instruction set to speed up otherwise cache-heavy matrix algorithms that I have written in the **01-matrix** project.
- I also inspect in detail blocking since it had the best performance of my original functions from **01-matrix**.
...
- Relevant computer architecture concepts:
  ...
  ![Alt text](images/instruction_pipeline2.png)
